        ...
        <div className="max-w-xl mx-auto text-center mb-8">
          ...
          <div className="mt-8 flex justify-center">
            <a 
              ...
              className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-zinc-900 border border-white/10 text-white font-semibold transition-all duration-300 hover:bg-[#25D366] hover:border-[#25D366] hover:shadow-[0_0_20px_rgba(37,211,102,0.4)] group"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" className="w-5 h-5 text-zinc-400 group-hover:text-white transition-colors">
              ...
              <span>Join the community for more info</span>
            </a>
          </div>
        </div>
