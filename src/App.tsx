...
const IncubatorProfile = lazy(() => import("./pages/IncubatorProfile"));
const SubmitIncubator = lazy(() => import("./pages/SubmitIncubator"));
  ...
  return (
    <AnimatePresence mode="wait" onExitComplete={() => window.scrollTo({ top: 0, behavior: 'instant' })}>
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/startups/submit" element={<PageTransition><SubmitStartup /></PageTransition>} />
        <Route path="/startups/:slug" element={<PageTransition><StartupProfile /></PageTransition>} />
        <Route path="/incubators" element={<PageTransition><Incubators /></PageTransition>} />
        <Route path="/incubators/submit" element={<PageTransition><SubmitIncubator /></PageTransition>} />
        <Route path="/incubators/:slug" element={<PageTransition><IncubatorProfile /></PageTransition>} />
        <Route path="/investors" element={<PageTransition><Investors /></PageTransition>} />
        <Route path="/investors/submit" element={<PageTransition><SubmitInvestor /></PageTransition>} />
        <Route path="/investors/:slug" element={<PageTransition><InvestorProfile /></PageTransition>} />
